...
public class CreateCell
{
    ...
    /**
     *  @brief this method creates all cells then finds their neighbours and starts threads
     * @param root it gives it to the cell
     * @param cellRow rows all of them
     * @param cellCollumn colummns, all of them
     * @param possibility cell uses it
     * @param speed cell uses it
     */
